...
function animate() {
  ...
  tl.addLabel('frame_1', 0.5)
    .to('#left_content', 0.7, { width: 'calc(50% - 10.5px)', ease: Power2.easeOut }, "frame_1")
    .to(['#faceL'], 0.45, { x: '107px', ease: Power2.easeOut }, "frame_1")
    .to(['#faceR'], 0.45, { x: '-107px', ease: Power2.easeOut }, "frame_1")
    .to(['#faceL'], 0.7, { x: 1, ease: Power2.easeOut }, "frame_1+=0.3")
    .to(['#faceR'], 0.7, { x: 2, ease: Power2.easeOut }, "frame_1+=0.3")
    ...
    // .to('#left_content', 1, { width: 'calc(50% - 10.5px)', ease: Power2.easeOut }, "frame_1+=1.1")
    .to(['#faceR'], 1, { x: '0', ease: Power2.easeOut }, "frame_1+=1.1")
    .to(['#h1L', '#h1R'], 0.5, { x: 0, ease: Power2.easeOut }, "frame_1+=1.5")


    .to('#left_content', 1.28, { width: '0', ease: 'none' }, "frame_1+=3")
    .to(['#faceL', '#faceR',], 1.5, { x: '-57%', ease: 'none' }, "frame_1+=3")
