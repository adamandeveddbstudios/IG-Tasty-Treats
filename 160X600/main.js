...
function animate() {
  ...
  tl.addLabel('frame_1', 0.5)
    ...
    // .to(['#faceL'], 0.45, { left: '51%', ease: Power2.easeOut }, "frame_1")
    .to(['#faceR'], 0.45, { x: '-51%', ease: Power2.easeOut }, "frame_1")
    .to(['#faceL'], 0.7, { left: -64, ease: Power2.easeOut }, "frame_1+=0.3")
    ...
    .to('#left_content', 0.41, { width: '0%', ease: 'none' }, "frame_1+=3")
